...
async function callAI(systemPrompt, userCode) {
    ...
    // --- TOKEN LOGGING ADDED HERE ---
    const usage = response.data.usage;
    
    // Safety check in case the API temporarily omits the usage block
    if (usage) {
        const cost =
        ...
        console.log('[TOKEN LOG] Usage data not returned by the API for this request.');
    }
    // ---------------------------------
